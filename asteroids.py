...
spaceship_img = load_image('/Users/user/Desktop/programovani/FirstProgram/others/playerShip2_green.png')
laser_img = load_image('/Users/user/Desktop/programovani/FirstProgram/others/laserGreen05.png')
space_img = load_image('/Users/user/Desktop/programovani/FirstProgram/others/darkPurple.png')
life_img = load_image('/Users/user/Desktop/programovani/FirstProgram/others/playerLife2_green.png')
ufo_img = load_image('/Users/user/Desktop/programovani/FirstProgram/others/ufoRed.png')
ufo_laser_img = load_image('/Users/user/Desktop/programovani/FirstProgram/others/laserRed11.png')
asteroid_images = {
    1: [load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_tiny1.png'),
        load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_tiny2.png'),
       ],
    2: [load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_small1.png'),
        load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_small2.png'),
       ],
    3: [load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_med1.png'),
        load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_med2.png'),
       ],
    4: [load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_big1.png'),
        load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_big2.png'),
        load_image('/Users/user/Desktop/programovani/FirstProgram/others/meteorGrey_big3.png'),
       ],
}
...
exhaust_images = []
for i in range(25):
    name = '/Users/user/Desktop/programovani/FirstProgram/others/playerShip2_damage1.png'.format(i)
...
pyglet.font.add_file('/Users/user/Desktop/programovani/FirstProgram/others/kenvector_future_thin.ttf')
level_label = pyglet.text.Label('Loading...', x=10, y=10, font_name='Kenvector Future Thin',)
...
class SpaceObject:
    ...
    def explode(self, explosion_size):
        for i in range(explosion_size):
            ...
            debris = Debris(self.window, x=self.x, y=self.y, x_speed=self.x_speed + rx * 3, y_speed=self.y_speed + ry * 3, time_to_live=4,)
            objects.append(debris)
            explosion = Exhaust(self.window, x=self.x, y=self.y, x_speed=self.x_speed + rx * 2, y_speed=self.y_speed + ry * 2, die_speed=1,)
            objects.append(explosion)

class Spaceship(SpaceObject):
    def __init__(self, window, rotation=0):
        super().__init__(window=window, image=spaceship_img, x=window.width / 2, y=window.height / 2, rotation=rotation, radius=SPACESHIP_RADIUS,)
        self.shoot_timer = 0
    ...
    def shoot(self):
        laser = ShipLaser(self.window, rotation=self.rotation, x=self.x, y=self.y, ship_x_speed=self.x_speed, ship_y_speed=self.y_speed, )
...
class Ufo(SpaceObject):
    def __init__(self, window):
        super().__init__(window=window, image=ufo_img, x=-UFO_RADIUS, y=random.uniform(UFO_RADIUS, window.height-UFO_RADIUS), x_speed=random.uniform(UFO_SPEED/2, UFO_SPEED*2), y_speed=UFO_SPEED, rotation=0, radius=UFO_RADIUS, batch=ufo_batch,)
        self.shoot_timer = 0
...
class Asteroid(SpaceObject):
    ...
    def __init__(self, window, size):
        ...
        if edge == 'vertical':
            ...
            y = 0
        super().__init__(window=window, image=random.choice(asteroid_images[size]), x=x, y=y, x_speed=random.uniform(-ASTEROID_SPEED, ASTEROID_SPEED), y_speed=random.uniform(-ASTEROID_SPEED, ASTEROID_SPEED), rotation=random.uniform(0, 360), radius=ASTEROID_RADIUSES[size],)
        self.size = size
    ...
    def hit_by_laser(self, laser):
        ...
        for i in range(2):
            ...
            for j in range(self.size):
                ...
                debris = Debris(self.window, x=self.x, y=self.y, x_speed=self.x_speed - split_y_speed + x_rand_speed, y_speed=self.y_speed + split_x_speed + y_rand_speed, time_to_live=self.size,)
                objects.append(debris)
...
class Laser(SpaceObject):
    def __init__(self, window, x, y, ship_x_speed, ship_y_speed, rotation, image=laser_img):
        ...
        super().__init__(window, x=x + math.cos(rotation_radians), y=y + math.sin(rotation_radians), x_speed=x_speed, y_speed=y_speed, rotation=rotation, image=image, radius=LASER_RADIUS,)
...
class UfoLaser(Laser):
    def __init__(self, ufo, ship):
        super().__init__(ufo.window, x=ufo.x, y=ufo.y, ship_x_speed=0, ship_y_speed=0, rotation=math.degrees(math.atan2(ship.y-ufo.y, ship.x-ufo.x)), image=ufo_laser_img,)
...
def make_exhaust(spaceship, side=0):
    ...
    return Exhaust(spaceship.window, x=spaceship.x + x_start * 43, y=spaceship.y + y_start * 43, x_speed=spaceship.x_speed + x_unit*speed + x_rand_speed, y_speed=spaceship.y_speed + y_unit*speed + y_rand_speed, die_speed=die_speed, small=side,)

class Exhaust(SpaceObject):
    def __init__(self, window, x, y, x_speed, y_speed, die_speed, small=False):
        super().__init__(window, x=x, y=y, x_speed=x_speed, y_speed=y_speed, image=random.choice(exhaust_images), radius=0, batch=exhaust_batch,)
        self.time_to_live = 2
...
class Debris(SpaceObject):
    def __init__(self, window, x, y, x_speed, y_speed, time_to_live):
        super().__init__(window, x=x, y=y, x_speed=x_speed, y_speed=y_speed, image=random.choice(asteroid_images[1]), radius=0, batch=exhaust_batch,)
